package com.swimshop.swim_mall.ai.returnrisk.client;
...
@Component
public class OpenAiReturnRiskClient {
    ...
    public String requestReturnRiskScoreJson(ReturnRiskScoreRequestDto requestDto) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Failed to serialize return risk request", e);
        }

        String systemPrompt = "You are a return-risk scoring assistant. "
                + "Output ONLY strict JSON with fields: "
                + "{\"score\":0.0,\"riskLevel\":\"LOW|MEDIUM|HIGH\",\"badgeText\":\"...\",\"guideText\":\"...\",\"reasons\":[\"...\"]}. "
