...
public class PartnerEventRewardOrderCapEntity {
    ...
    public PartnerEventRewardOrderCapEntity(EventEntity event, CustomerEntity customer, Long orderNo) {
        this.event = event;
