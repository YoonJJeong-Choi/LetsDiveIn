...
export const protectedRoutes = [
    ...
    {
        key: 'apps.admin.return-risk-logs',
        path: `${APP_PREFIX_PATH}/apps/admin/return-risk-logs`,
        component: React.lazy(() => import('views/app-views/apps/admin/return-risk-logs')),
    },
    {
