...
import { Card, Row, Col, Statistic, DatePicker, Space, Button, Table, Tag, Spin, message } from 'antd';
...
const PartnerSalesStatistics = () => {
	...
	const fetchStatistics = async () => {
		try {
			...
			const response = await PartnerService.getSalesStatistics(startDate, endDate);
...
export default PartnerSalesStatistics;
